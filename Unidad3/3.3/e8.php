...
<body>
    ...
    if ($_SERVER["REQUEST_METHOD"] === "POST") {
        ...
        echo "<p>Numeros ingresados: $numeros oepraciones seleccionados  $seleccion</p>";
        ...
        if (isset($_COOKIE["numeros"]) && isset($_COOKIE["operaciones"])) {
            ...
            echo "<p>Numeros ingresados: $numerosAnteriores oepraciones seleccionados  $operacionesAnteriores</p>";
        } else {
